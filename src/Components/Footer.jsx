...
export function Footer() {
  return (
    <section className="relative overflow-hidden bg-gradient-to-r from-blue-700 to-cyan-500 py-8">
          ...
          <div className="w-auto p-8">
            <a href="#">
              <div className="inline-flex items-center">
                ...
                <span className="ml-4 text-white font-serif text-2xl font-bold">Landing Page</span>
              </div>
            </a>
          </div>
          <div className="w-auto p-8">
